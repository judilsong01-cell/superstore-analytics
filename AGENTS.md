# AGENTE DO PROJETO — Superstore Analytics

## 1. CONTEXTO

Análise comercial de vendas, lucro, descontos, produtos, clientes, regiões e desempenho de categorias.
...
- Avaliar impacto dos descontos
- Construir tabelas dinâmicas
- Criar gráficos comparativos em Google Sheets e R
...
- Que produtos ou regiões apresentam prejuízo?
- Qual é o impacto dos descontos sobre o lucro?
- Que segmentos e clientes são mais relevantes?
